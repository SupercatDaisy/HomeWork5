...
public abstract class TestBase {
    protected WebDriverWait wait; // will be visible in the subclass regardless of location
    //out of package even
...
//@Optional to make parameter optional
    //if you dont specifiy it testng will require to specify this parameter fr every test in xml runner
    @BeforeTest
